...
module.exports = {
  ...
  construct: function(self, options) {
    ...
    self.profilerSuggestIndex = function(criteria, sort) {
      ...
      // always use an existing index efficiently. However
      // in the presence of a sort MongoDB might not make
      // good choices
      ...
      if (!profiler.indexSuggestionsTimeout) {
        profiler.indexSuggestionsTimeout = setTimeout(function() {
          ...
          if (indexes.length) {
            ...
            self.apos.utils.log('See the documentation for important information.');
          } else {
            self.apos.utils.log('\nNo suggested indexes so far.\n');
          }
